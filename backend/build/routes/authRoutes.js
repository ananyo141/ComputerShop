...
exports.authRouter.post("/register", authControllers_1.registerController);
exports.authRouter.post("/logout", authControllers_1.logoutController);
exports.authRouter.use((_req, _res, _next) => {
