        ...
        <div className="relative pt-10 xl:pt-20">
          <div className="absolute inset-x-0 bottom-12 flex flex-col gap-3 px-5 xl:bottom-24 xl:gap-5">
            ...
            <button
              data-mdb-ripple="true"
              data-mdb-ripple-color="light"
              className="mx-auto inline-block w-72 rounded-xl px-2 py-2.5 text-xs font-medium uppercase leading-tight text-gray-800 border-2 shadow-md transition duration-150 ease-in-out hover:bg-gray-200 hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg md:w-full lg:px-3"
              onClick={onAddToCart}
            >
              Add to cart
            </button>
