  ...
  return (
    <div className="container my-24 mx-auto px-6">
      ...
      <section className="mb-32 text-gray-800">
        <div
          className="relative origin-top h-[300px] lg:h-[400px] overflow-hidden bg-cover bg-no-repeat"
        ...
        <div className="container px-4 text-gray-800 md:px-12">
          <div className="-mt-24 block rounded-lg bg-[hsla(0,0%,100%,0.8)] py-10 px-2 shadow-lg backdrop-blur-[30px] md:py-12 md:px-6">
