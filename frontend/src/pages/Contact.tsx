...
<div className="container my-24 px-6 mx-auto">
  ...
  <section className="mb-32 text-gray-800">
    ...
    <div className="relative overflow-hidden bg-no-repeat bg-cover"
      ...
      style={{ height: "300px", backgroundPosition: "50%", backgroundImage: "url('https://mdbootstrap.com/img/new/textures/full/284.jpg')" }} >
    </div>
    <div className="container text-gray-800 px-4 md:px-12">
      <div className="block rounded-lg shadow-lg py-10 md:py-12 px-2 md:px-6 -mt-24 bg-[hsla(0,0%,100%,0.8)] backdrop-blur-[30px]">
